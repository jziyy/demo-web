 ...
 * RequestMappingHandlerMapping} so when a request comes in,
 * {@link RequestMapping}s located inside a class annotated with {@link
...
public class FrameworkControllerHandlerMapping extends RequestMappingHandlerMapping {
    ...
    protected RequestMappingInfo getMappingForMethod(Method method, Class<?> handlerType) {
        ...
        if(requestMappingInfo != null) {
            this.logger.debug(
                "RequestMappingInfo:-----" + requestMappingInfo.getName() + requestMappingInfo
                    .toString());
        }
